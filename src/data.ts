...
export const pools: PoolLocation[] = [
  {
    ...
    address: '100 West Rescue Blvd, Springfield',
    phone: '(555) 800-9378',
    lanes: 8,
    maxCapacity: 120,
    amenities: ['Olympic Lap Pool', 'Diving Boards', 'Water Slide', 'Heated Locker Rooms', 'On-site Lifeguards', 'ADA Accessible'],
    hours: {
  ...
  },
  {
    ...
    address: '250 South Station Ave, Springfield',
    phone: '(555) 800-7884',
    lanes: 6,
    maxCapacity: 80,
